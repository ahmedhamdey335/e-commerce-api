...
<head>
    ...
    <title>Laravel e-commerce stotre API documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-admin-orders">GET api/admin/orders</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-admin-orders--order_id--status">
                                <a href="#endpoints-PATCHapi-admin-orders--order_id--status">PATCH api/admin/orders/{order_id}/status</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<ul>
<li>@bodyParam name string required The name of the user. Example: John Doe</li>
</ul>
...
<div class="bash-example">
    ...
    --form "stock=42"\
    --form "categories[]=16"\
    --form "image=@/tmp/phpg7h19fv1d2cdcYpxpLQ" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpg7h19fv1d2cdcYpxpLQ</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "stock=42"\
    --form "categories[]=16"\
    --form "image=@/tmp/phpt3ufs5euvv320eEIaGl" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpt3ufs5euvv320eEIaGl</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-admin-orders--order_id--status">PATCH api/admin/orders/{order_id}/status</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/admin/orders/16/status" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
Must be one of:
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>paid</code></li> <li><code>shipped</code></li> <li><code>cancelled</code></li></ul>
        </div>
        </form>
